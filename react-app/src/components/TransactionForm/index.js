    ...
    return (
        <div className="transaction-container">
            <div className="top-container">
                <div className="buy-sell-container">
                    <div className="transaction-type">
                        <button
                            className={`transaction-type-button-off ${isBuy ? 'transaction-type-button-on' : ''
                                }`}
            ...
            <form onSubmit={handleSubmit}>
                <div
                    className={`transaction-form-container-shares ${type == 'Dollars' ? 'transaction-form-container-dollars' : ''
                        }`}
                >
